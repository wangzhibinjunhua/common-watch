...
import com.example.watch.health.BluetoothLeClass.OnDataAvailableListener;
import com.example.watch.health.BluetoothLeClass.OnServiceDiscoverListener;
    ...
    private final BluetoothGattCallback mBleCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
            	...
            	displayGattServices(getSupportedGattServices());//add by wzb for debug
            	if(mOnServiceDiscoverListener != null)mOnServiceDiscoverListener.onServiceDiscover(gatt);
