...
public class HomeArc extends View { 
	...
	private RectF rectf;
	private float tb;
	private int blackColor = 0x70000000; 
	...
	public void init(int score) {
		...
		tb = res.getDimension(R.dimen.historyscore_tb)*0.8f;
		...
		paint_white.setTextSize(tb*6.0f*2);
	...
	protected void onDraw(Canvas c) {
		...
		c.drawText("" + score_text, tb * 9.7f, tb * 14.0f, paint_white);
	}
